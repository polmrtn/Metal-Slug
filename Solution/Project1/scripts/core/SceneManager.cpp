...
static void IntroFramePath(char* buf, int bufSize, int zeroBasedIdx)
{
    snprintf(buf, bufSize,
        "Graphics/screens/intro/frames/frames_png/frame_%06d.png",
        zeroBasedIdx + 1);
}
...
{
    texSplash = LoadTexture("Graphics/screens/titlescreen.png");
    SetTextureFilter(texSplash, TEXTURE_FILTER_POINT);

    // Title screen textures
    texBrrrt = LoadTexture("Graphics/screens/intro/corr/introback.png");
    texExplo2sprites = LoadTexture("Graphics/screens/intro/corr/newintro2explosprites.png");
    texMetalBig = LoadTexture("Graphics/screens/intro/corr/NEWintroMETALSLUG1.png");
    texSlugTM = LoadTexture("Graphics/screens/intro/corr/NEWINTROmetalslugTM.png");
    ...
    for (;;)
    {
        ...
        snprintf(htpPath, sizeof(htpPath),
            "Graphics/screens/howtoplay_png/frame_%06d.png", htpTotalFrames + 1);
...
void SceneManager::ResetHowtoplay()
{
    ...
    char path[512];
    snprintf(path, sizeof(path), "Graphics/screens/howtoplay_png/frame_%06d.png", 1);
...
void SceneManager::HtpStartPreload(int slot, int frameIdx)
{
    ...
    char path[512];
    snprintf(path, sizeof(path), "Graphics/screens/howtoplay_png/frame_%06d.png", frameIdx + 1);
    std::string pathStr(path);
