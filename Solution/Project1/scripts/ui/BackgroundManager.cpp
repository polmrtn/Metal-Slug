...
void BackgroundManager::Init() {
    AddSprite("Graphics/background sprites/background_1.png", { 8000, 155 }, 4.0f, 0.05f, 1.0f, false, 0);
    AddSprite("Graphics/background sprites/background_3.png", { 10300, 0 }, 4.0f, 0.05f, 1.5f, false, 1);
    AddSprite("Graphics/background sprites/huts/platform_7.png", { 11170, 750 }, 4.0f, 0.0f, 1.0f, true, 1);
    AddSprite("Graphics/background sprites/background_7.png", { 0, -165 }, 4.0f, 0.0f, 1.0f, false, 1);
    AddSprite("Graphics/background sprites/huts/rock.png", { 2200, 670 }, 4.0f, 0.0f, 1.0f, false, 1);
    AddSprite("Graphics/background sprites/huts/rock.png", { 7700, 800 }, 4.0f, 0.0f, 1.0f, false, 2);
    AddSprite("Graphics/background sprites/huts/metal_2.png", { 5400, 690 }, 4.0f, 0.0f, 1.0f, true, 1);
    AddSprite("Graphics/background sprites/background_11.png", { 14070, -450 }, 4.0f, 0.0f, 1.0f, true, 2);
  

    AddAnimation("Graphics/background sprites/background_6.png", { 12000, 0 }, 8, 25.0f, 4.0f, 0.0f, 0.7f, 1.2f, false, 0, 1);
    AddAnimation("Graphics/background sprites/background_5.png", { 14500, -350 }, 5, 25.0f, 4.0f, 2.0f, 0.17f, 1.0f, false, 1, 1);
    AddAnimation("Graphics/background sprites/background_9.png", { 7440, 856 }, 8, 15.0f, 4.0f, 2.0f, 0.0f, 1.0f, false, 1, 1);
    AddAnimation("Graphics/background sprites/background_10.png", { 13350, -165 }, 8, 15.0f, 4.0f, 2.0f, 0.0f, 1.0f, false, 2, 1);
    AddAnimation("Graphics/background sprites/background_8.png", { 13340, -165 }, 8, 300.0f, 4.0f, 2.0f, 0.0f, 1.0f, true, 2, 2);
    AddAnimation("Graphics/background sprites/background_13.png", { 7540, 930 }, 8, 15.0f, 4.0f, 2.0f, 0.0f, 1.0f, true, 2, 6);
    AddAnimation("Graphics/background sprites/background_12.png", { 15000, 600 }, 8, 30.0f, 4.0f, 2.0f, 0.0f, 1.0f, true, 2);

    AddEventSprite("Graphics/background sprites/huts/huts_6.png", { 11600, 150 }, 1, 4.0f, 0.0f, 0.0f, false, 1);
    AddEventSprite("Graphics/background sprites/huts/platform_6.png", { 8080, 800 }, 1, 4.0f, 0.0f, 0.0f, false, 1);
