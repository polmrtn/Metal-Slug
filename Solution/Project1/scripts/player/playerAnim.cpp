...
void PlayerAnim::LoadTextures() {
    Image img = LoadImage("Graphics/characters/marco_sprites.png");
...
void PlayerAnim::LoadParachute() {
    Image img = LoadImage("Graphics/other/parachute_1.png");
...
void PlayerAnim::LoadParachute2() {
    Image img = LoadImage("Graphics/other/parachute_2.png");
