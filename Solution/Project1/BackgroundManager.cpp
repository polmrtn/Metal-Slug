...
void BackgroundManager::Init() {
    ...
    AddSprite("Graphics/background sprites/more shit and huts/woodenbalcony.png", { 11170, 750 }, 4.0f, 0.0f, 1.0f, true, 1);
    ...
    AddEventSprite("Graphics/background sprites/more shit and huts/somewoodenstructure.png", { 11600, 150 }, 1, 4.0f, 0.0f, 0.0f, false, 1);
